      ...
      case 'wallet':
        return (
          <div className="p-5 md:p-6">
            ...
            {/* Card de Faturamento Total no Modal */}
    ...
    <div className="flex bg-gray-50 min-h-screen font-sans w-full relative">
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-[70px] md:w-20 bg-white border-r border-gray-200 flex flex-col items-center pt-6 pb-6 gap-4 md:gap-6 shadow-sm z-20">
        ...
        <nav className="flex flex-col gap-3 md:gap-4 flex-1 w-full px-2 overflow-y-auto custom-scrollbar">
          ...
          {/* Calendário - Configurar expediente */}
          ...
          {/* Bonequinho - Agora na paleta Cinza/Rosa */}
          ...
          {/* Sair */}
          <button className="w-full flex justify-center p-2.5 md:p-3 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-xl transition group relative mb-4 md:mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Área Principal de Conteúdo - Com margem para compensar a barra fixa */}
